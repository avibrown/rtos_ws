...
TaskProfiler BlueTaskProfiler, GreenTaskProfiler, RedTaskProfiler, OrangeTaskProfiler;
...
int main(void)
{
  ...
  /* Green and Orange have equal priority
   * so they will both execute. The other
   * tasks will not even execute.
   * */
